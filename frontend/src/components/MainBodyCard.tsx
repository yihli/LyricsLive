...
const MainBodyCard = ({ loginSpotify }) => {
    return (
        <div className='rounded-xl flex flex-col items-center justify-center bg-gray-200 w-3/5 mt-[4rem] py-7 gap-8'>
           ...
           <div className='h-[3rem] w-[10rem] bg-black flex flex-row justify-center items-center gap-2 rounded-2xl'>
                <img className='h-3/5' src={spotifyLogo}/>
                <div className='text-white' onClick={loginSpotify}>Spotify login</div>
            </div>
        </div>
    );
};
